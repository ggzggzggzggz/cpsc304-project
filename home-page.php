...
<body>
	...
	<form method="POST" action="home-page.php">
		...
		<p><input type="submit" value="Reset and Reload" name="reset"></p>
	</form>

    <hr />

    <h2>Menu</h2>
    <a href="./display.php">Display Tuples</a>
    <br>
    <a href="./insert.php">Insert Values into SportsPeople, Coach, and Athlete Table</a>
    <br>
    <a href="./delete.php">Delete Values from PlayFor and Participates Table</a>
    <br>
    <a href="./update.php">Update League</a>
    <br>
    <a href="./select.php">Select Sport People</a>
    <br>
    <a href="./projection.php">Select Columns from Match2 Table (Projection)</a>
    <br>
    <a href="./nagb.php">Find the Venues that's capacity are less than all of averages of every location (Nested Aggregation with GROUP BY)</a>
    <br>
    <a href="./division.php">Find the corporations that sponsor all teams (Division)</a>
    <br>
    <a href="./ah.php">Find Coaches with Minimum Years of Activity (Aggregation with HAVING)</a>
    <br>
    <a href="./join.php">Join Values from PlayFor and Team</a>
    <br>
    <a href="./agb.php">Total Number of Sports People of a Nationality (Aggregation with GROUP BY)</a>
