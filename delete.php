...
<body>
    ...
    <h2>Delete Values from PlayFor Table</h2>
    <form method="GET" action="delete.php">
        <input type="hidden" id="displayPlayForTuplesRequest" name="displayPlayForTuplesRequest">
        <input type="submit" value="Display PlayFor" name="displayPlayForTuples"></p>
    </form>
    <form method="POST" action="delete.php">
        <input type="hidden" id="deletePlayForRequest" name="deletePlayForRequest">
        teamID: <input type="text" name="deleteTeamID" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"> <br /><br />
        sportPeopleName: <input type="text" name="deleteSportPeopleName" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z- ]/g,'');"> <br /><br />
        sportPeopleDateOfBirth: <input type="text" name="deleteSportPeopleDateOfBirth" onkeyup="this.value=this.value.replace(/[^0-9-]/g,'');"> <br /><br />
        <input type="submit" value="Delete" name="deleteSubmit"></p>
    </form>

    <hr />

    <h2>Delete Values from Participates Table</h2>
    <form method="GET" action="delete.php">
        <input type="hidden" id="displayParticipatesTuplesRequest" name="displayParticipatesTuplesRequest">
        <input type="submit" value="Display Participates" name="displayParticipatesTuples"></p>
    </form>
    <form method="POST" action="delete.php">
        <input type="hidden" id="deleteParticipatesRequest" name="deleteParticipatesRequest">
        teamID: <input type="text" name="deleteTeamID" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"> <br /><br />
        seasonYear: <input type="text" name="deleteSeasonYear" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"> <br /><br />
        leagueName: <input type="text" name="deleteLeagueName" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z- ]/g,'');"> <br /><br />
...
//                echo "<br>";
    ...
    function handleDisplayPlayForRequest()
    {
        global $db_conn;
    ...
    function handleDisplayParticipatesRequest()
    {
        global $db_conn;
    ...
    function handleDeleteFromPlayFor()
    {
        ...
        if (empty($deleteSportPeopleName) && $deleteSportPeopleName!=0) {
            echo "SportPeople Name is empty. Please provide a valid SportPeople Name.";
            oci_commit($db_conn);
            return; // Exit the function if deleteTeamID is empty
        }

        if (empty($deleteSportPeopleDateOfBirth) && $deleteSportPeopleDateOfBirth!=0) {
            echo "SportPeople DateOfBirth is empty. Please provide a valid SportPeople DateOfBirth.";
            oci_commit($db_conn);
            return; // Exit the function if deleteTeamID is empty
        }

        $result = executePlainSQL("SELECT * FROM PlayFor WHERE TeamID = $deleteTeamID AND SportPeopleName = '$deleteSportPeopleName' AND SportPeopleDateOfBirth = '$deleteSportPeopleDateOfBirth'");
        $result = OCI_Fetch_Array($result, OCI_ASSOC);
        if (!$result) {
            echo "<br>";
            echo "<br>";
            echo "Please input existing items in PlayFor Table";
            echo "<br>";
            return;
        }
    ...
    function handleDeleteFromParticipates()
    {
        ...
        if (empty($deleteLeagueName) && $deleteLeagueName!=0) {
            echo "LeagueName is empty. Please provide a valid SeasonYear.";
            oci_commit($db_conn);
            return; // Exit the function if deleteTeamID is empty
        }

        $result = executePlainSQL("SELECT * FROM Participates WHERE TeamID = $deleteTeamID AND SeasonYear = $deleteSeasonYear AND LeagueName = '$deleteLeagueName'");
        $result = OCI_Fetch_Array($result, OCI_ASSOC);
        if (!$result) {
            echo "<br>";
            echo "<br>";
            echo "Please input existing items in Participates Table";
            echo "<br>";
            return;
        }
    ...
    function handleJoinRequest() {
        ...
        $result = executeSelectPlainSQL("SELECT * FROM PlayFor p, Team t WHERE p.teamID = t.ID AND t.name = '$teamName'");
	...
	function handleGETRequest()
	{
		if (connectToDB()) {
            ...
            } elseif (array_key_exists('displayPlayForTuples', $_GET)) {
                handleDisplayPlayForRequest();
            } elseif (array_key_exists('displayParticipatesTuples', $_GET)) {
                handleDisplayParticipatesRequest();
            }
