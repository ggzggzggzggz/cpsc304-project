...
<body>
    ...
    <h2>Insert Values into SportsPeople, Coach and Athlete Table</h2>
    <h3>Display SportsPeople, Coach and Athlete table</h3>
    <form method="GET" action="insert.php">
        <input type="hidden" id="displaySportsPeopleTuplesRequest" name="displaySportsPeopleTuplesRequest">
        <input type="submit" value="Display" name="displaySportsPeopleTuples"></p>
    </form>
    <h3>Insert Values into SportsPeople Table</h3>
    <form method="POST" action="insert.php">
        <input type="hidden" id="insertSportsPeopleRequest" name="insertSportsPeopleRequest">
        name: <input type="text" name="insName" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />
        dateOfBirth: <input type="text" name="insDateOfBirth" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z -]/g,'');"> <br /><br />
        nationality: <input type="text" name="insNationality" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />

        <input type="submit" value="Insert" name="insertSubmit"></p>
    </form>
    <h3>Insert Values into Coach Table</h3>
    <form method="POST" action="insert.php">
        <input type="hidden" id="insertCoachRequest" name="insertCoachRequest">
        name: <input type="text" name="insName" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />
        dateOfBirth: <input type="text" name="insDateOfBirth" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z -]/g,'');"> <br /><br />
        yearsActive: <input type="text" name="insYearsActive" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />

        <input type="submit" value="Insert" name="insertSubmit"></p>
    </form>
    <h3>Insert Values into Athlete Table</h3>
    <form method="POST" action="insert.php">
        <input type="hidden" id="insertAthleteRequest" name="insertAthleteRequest">
        name: <input type="text" name="insName" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />
        dateOfBirth: <input type="text" name="insDateOfBirth" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z -]/g,'');"> <br /><br />
        position: <input type="text" name="insPosition" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />
        injuryHistory: <input type="text" name="insInjuryHistory" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />
...
//                echo "<br>";
    ...
    function handleDeleteFromPlayFor()
    {
        ...
        $sql = "DELETE FROM PlayFor WHERE TeamID = :teamID AND SportPeopleName = :sportPeopleName AND SportPeopleDateOfBirth = :sportPeopleDOB";
        $statement = oci_parse($db_conn, $sql);

        oci_bind_by_name($statement, ":teamID", $deleteTeamID);
        oci_bind_by_name($statement, ":sportPeopleName", $deleteSportPeopleName);
        oci_bind_by_name($statement, ":sportPeopleDOB", $deleteSportPeopleDateOfBirth);
        ...
        if (oci_execute($statement)) {
            ...
            if(strstr($errorMessage, 'invalid number')){
                echo "<br>";
                echo "<br>";
                echo "Please input number for TeamID!";
                echo "<br>";
            }else if(strstr($errorMessage,"maximum")){
                echo "<br>";
                echo "Please limit of String input to 255!";
                echo "<br>";
            }
    ...
    function handleDeleteFromParticipates()
    {
        ...
        $sql = "DELETE FROM Participates WHERE TeamID = :teamID AND SeasonYear = :seasonYear AND LeagueName = :leagueName";
        $statement = oci_parse($db_conn, $sql);

        oci_bind_by_name($statement, ":teamID", $deleteTeamID);
        oci_bind_by_name($statement, ":seasonYear", $deleteSeasonYear);
        oci_bind_by_name($statement, ":leagueName", $deleteLeagueName);
        ...
        if (oci_execute($statement)) {
            ...
            if(strstr($errorMessage, 'invalid number')){
                echo "<br>";
                echo "<br>";
                echo "Please input number for TeamID and SeasonYear!";
                echo "<br>";
            }else if(strstr($errorMessage,"maximum")){
                echo "<br>";
                echo "Please limit of String input to 255!";
