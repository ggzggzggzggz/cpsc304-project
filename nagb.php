...
<body>
    ...
    <p>Find the Venues that's capacity are less than all of averages of every location</p>
    <form method="GET" action="nagb.php">
        <input type="hidden" id="nagbRequest" name="nagbRequest">
        <input type="submit" value="Get" name="nagb"></p>
    </form>
