...
$config["dbuser"] = "username";			// change "cwl" to your own CWL
...
<body>
	...
	<h2>Update League</h2>
    <h3>Please first click below button to display League table and Sport table</h3>
    <form method="GET" action="update.php">
        <input type="hidden" id="displayLeagueTuplesRequest" name="displayLeagueTuplesRequest">
        <input type="submit" value="Display" name="displayLeagueTuples"></p>
    </form>
    <h3>Change League table</h3>
	<form method="POST" action="update.php">
        <p>Please first select fields you want to change, and then fill its name and new contents for what you select!</p>
        <label><input type="checkbox" name="up[]" value="name"/>name</label> <br /><br />
        <label><input type="checkbox" name="up[]" value="region" />region</label> <br /><br />
        <label><input type="checkbox" name="up[]" value="sportName" />sportName</label> <br /><br />
        <input type="hidden" id="updateQueryRequest" name="updateQueryRequest">
		Name: <input type="text" name="oldName" required onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />
		New Name: <input type="text" name="newName" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />
        New Region: <input type="text" name="newRegion" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />
        New Sport Name: <input type="text" name="newSportName" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"> <br /><br />
