...
<body>
    ...
    <h2>Select Columns from Match2 Table</h2>
    <form method="POST" action="projection.php">
    <input type="hidden" id="projectionMatch2" name="projectionMatch2">
        ...
        <select multiple name="columns[]" size="7">
            ...
            <option value="venueLocation">Venue Location</option>
            <option value="venueName">Venue Name</option>
            <option value="leagueName">League Name</option>
            <option value="seasonYear">Season Year</option>
        </select>
        <br><br>
