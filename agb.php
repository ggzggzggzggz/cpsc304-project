...
<body>
    ...
    <h2>Total Number of Sports People of a Nationality</h2>
    <form method="GET" action="agb.php">
        <input type="hidden" id="displayTeamTuplesRequest" name="displayTeamTuplesRequest">
        <input type="submit" value="Display Sports People" name="displayTeamTuples"></p>
    </form>
    <form method="GET" action="agb.php">
        <input type="hidden" id="groupByRequest" name="groupByRequest">
        Nationality: <input type="text" name="nationality" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z ]/g,'');"><br><br>
        <input type="submit" value="Get" name="groupBy">
    </form>
