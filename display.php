...
<body>
    ...
    <form method="GET" action="display.php">
        ...
        <select name="S">
            ...
            <option value="SportsPeople">SportsPeople</option>
            <option value="Corporation">Corporation</option>
            <option value="Sponsor">Sponsor</option>
            <option value="CompetesAt">CompetesAt</option>
            <option value="League">League</option>
            <option value="SeasonOrganizes">SeasonOrganizes</option>
            <option value="Participates">Participates</option>
            <option value="PlayFor">PlayFor</option>
        ...
        <input type="hidden" id="displayTuplesRequest" name="displaySelectTuplesRequest">
        <input type="submit" value="Submit" name="displaySelectTuples"></p>
    </form>
