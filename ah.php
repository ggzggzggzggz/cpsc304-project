...
<body>
    ...
    <h2>Find Coaches with Minimum Years of Activity</h2>
    <form method="POST" action="ah.php">
        <input type="hidden" id="coachQueryRequest" name="coachQueryRequest">

        <label for="yearsActive">Enter Minimum Years Active:</label>
        <input type="number" id="yearsActive" name="yearsActive" min="0"><br><br>

        <input type="submit" value="Submit" name="findCoaches">
    </form>
