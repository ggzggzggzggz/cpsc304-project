...
<head>
	<title>Select Sport People</title>
</head>
...
<body>
    ...
    <h2>Select Sport People</h2>
    <h3>Display SportsPeople</h3>
    <form method="GET" action="select.php">
        <input type="hidden" id="displaySportsPeopleOnlyTuplesRequest" name="displaySportsPeopleOnlyTuplesRequest">
        <input type="submit" value="Display" name="displaySportsPeopleOnlyTuples"></p>
    </form>
    <h3>Selection</h3>
    <p>Please use it in order! Don't input anything if in previous lines there are still existing NA!</p>
    <form method="GET" action="select.php">
        ...
        = <input type="text" name="t1" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z -]/g,'');"> <br /><br />
        <select name="L1">
        ...
        = <input type="text" name="t2" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z -]/g,'');"> <br /><br />
        <select name="L2">
            <option value="NA">NA</option>
            <option value="AND">AND</option>
            <option value="OR">OR</option>
        ...
        = <input type="text" name="t3" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z -]/g,'');"> <br /><br />
        <select name="L3">
            <option value="NA">NA</option>
            <option value="AND">AND</option>
            <option value="OR">OR</option>
        ...
        = <input type="text" name="t4" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z -]/g,'');"> <br /><br />
        <select name="L4">
            <option value="NA">NA</option>
            <option value="AND">AND</option>
            <option value="OR">OR</option>
        ...
        = <input type="text" name="t5" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z -]/g,'');"> <br /><br />
